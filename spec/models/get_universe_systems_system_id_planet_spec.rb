...
# Unit tests for EveESIClient::GetUniverseSystemsSystemIdPlanet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniverseSystemsSystemIdPlanet' do
  before do
    # run before each test
    @instance = EveESIClient::GetUniverseSystemsSystemIdPlanet.new
  end
  ...
  describe 'test an instance of GetUniverseSystemsSystemIdPlanet' do
    it 'should create an instance of GetUniverseSystemsSystemIdPlanet' do
      expect(@instance).to be_instance_of(EveESIClient::GetUniverseSystemsSystemIdPlanet)
    end
  end
