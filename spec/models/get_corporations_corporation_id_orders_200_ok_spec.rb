...
# Unit tests for EveESIClient::GetCorporationsCorporationIdOrders200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdOrders200Ok' do
  before do
    # run before each test
    @instance = EveESIClient::GetCorporationsCorporationIdOrders200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdOrders200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdOrders200Ok' do
      expect(@instance).to be_instance_of(EveESIClient::GetCorporationsCorporationIdOrders200Ok)
    end
  end
  ...
  describe 'test attribute "state"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["cancelled", "character_deleted", "closed", "expired", "open", "pending"])
       #validator.allowable_values.each do |value|
