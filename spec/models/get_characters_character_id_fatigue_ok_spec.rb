...
# Unit tests for EveESIClient::GetCharactersCharacterIdFatigueOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdFatigueOk' do
  before do
    # run before each test
    @instance = EveESIClient::GetCharactersCharacterIdFatigueOk.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdFatigueOk' do
    it 'should create an instance of GetCharactersCharacterIdFatigueOk' do
      expect(@instance).to be_instance_of(EveESIClient::GetCharactersCharacterIdFatigueOk)
    end
  end
