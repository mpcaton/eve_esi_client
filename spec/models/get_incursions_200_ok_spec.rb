...
# Unit tests for EveESIClient::GetIncursions200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetIncursions200Ok' do
  before do
    # run before each test
    @instance = EveESIClient::GetIncursions200Ok.new
  end
  ...
  describe 'test an instance of GetIncursions200Ok' do
    it 'should create an instance of GetIncursions200Ok' do
      expect(@instance).to be_instance_of(EveESIClient::GetIncursions200Ok)
    end
  end
