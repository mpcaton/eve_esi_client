...
# Unit tests for EveESIClient::GetUniverseStargatesStargateIdDestination
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniverseStargatesStargateIdDestination' do
  before do
    # run before each test
    @instance = EveESIClient::GetUniverseStargatesStargateIdDestination.new
  end
  ...
  describe 'test an instance of GetUniverseStargatesStargateIdDestination' do
    it 'should create an instance of GetUniverseStargatesStargateIdDestination' do
      expect(@instance).to be_instance_of(EveESIClient::GetUniverseStargatesStargateIdDestination)
    end
  end
