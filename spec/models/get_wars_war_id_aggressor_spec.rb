...
# Unit tests for EveESIClient::GetWarsWarIdAggressor
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetWarsWarIdAggressor' do
  before do
    # run before each test
    @instance = EveESIClient::GetWarsWarIdAggressor.new
  end
  ...
  describe 'test an instance of GetWarsWarIdAggressor' do
    it 'should create an instance of GetWarsWarIdAggressor' do
      expect(@instance).to be_instance_of(EveESIClient::GetWarsWarIdAggressor)
    end
  end
