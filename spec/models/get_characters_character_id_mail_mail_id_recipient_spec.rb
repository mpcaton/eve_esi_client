...
# Unit tests for EveESIClient::GetCharactersCharacterIdMailMailIdRecipient
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdMailMailIdRecipient' do
  before do
    # run before each test
    @instance = EveESIClient::GetCharactersCharacterIdMailMailIdRecipient.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdMailMailIdRecipient' do
    it 'should create an instance of GetCharactersCharacterIdMailMailIdRecipient' do
      expect(@instance).to be_instance_of(EveESIClient::GetCharactersCharacterIdMailMailIdRecipient)
    end
  end
