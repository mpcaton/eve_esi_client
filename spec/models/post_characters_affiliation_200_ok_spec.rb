...
# Unit tests for EveESIClient::PostCharactersAffiliation200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostCharactersAffiliation200Ok' do
  before do
    # run before each test
    @instance = EveESIClient::PostCharactersAffiliation200Ok.new
  end
  ...
  describe 'test an instance of PostCharactersAffiliation200Ok' do
    it 'should create an instance of PostCharactersAffiliation200Ok' do
      expect(@instance).to be_instance_of(EveESIClient::PostCharactersAffiliation200Ok)
    end
  end
