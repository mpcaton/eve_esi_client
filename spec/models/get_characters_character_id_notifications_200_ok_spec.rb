...
# Unit tests for EveESIClient::GetCharactersCharacterIdNotifications200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdNotifications200Ok' do
  before do
    # run before each test
    @instance = EveESIClient::GetCharactersCharacterIdNotifications200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdNotifications200Ok' do
    it 'should create an instance of GetCharactersCharacterIdNotifications200Ok' do
      expect(@instance).to be_instance_of(EveESIClient::GetCharactersCharacterIdNotifications200Ok)
    end
  end
