...
# Unit tests for EveESIClient::GetCharactersCharacterIdChatChannelsMuted
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdChatChannelsMuted' do
  before do
    # run before each test
    @instance = EveESIClient::GetCharactersCharacterIdChatChannelsMuted.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdChatChannelsMuted' do
    it 'should create an instance of GetCharactersCharacterIdChatChannelsMuted' do
      expect(@instance).to be_instance_of(EveESIClient::GetCharactersCharacterIdChatChannelsMuted)
    end
  end
