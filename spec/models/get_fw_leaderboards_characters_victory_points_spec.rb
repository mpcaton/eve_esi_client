...
# Unit tests for EveESIClient::GetFwLeaderboardsCharactersVictoryPoints
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwLeaderboardsCharactersVictoryPoints' do
  before do
    # run before each test
    @instance = EveESIClient::GetFwLeaderboardsCharactersVictoryPoints.new
  end
  ...
  describe 'test an instance of GetFwLeaderboardsCharactersVictoryPoints' do
    it 'should create an instance of GetFwLeaderboardsCharactersVictoryPoints' do
      expect(@instance).to be_instance_of(EveESIClient::GetFwLeaderboardsCharactersVictoryPoints)
    end
  end
