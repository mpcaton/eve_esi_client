...
# Unit tests for EveESIClient::GetCorporationsCorporationIdStandings200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdStandings200Ok' do
  before do
    # run before each test
    @instance = EveESIClient::GetCorporationsCorporationIdStandings200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdStandings200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdStandings200Ok' do
      expect(@instance).to be_instance_of(EveESIClient::GetCorporationsCorporationIdStandings200Ok)
    end
  end
