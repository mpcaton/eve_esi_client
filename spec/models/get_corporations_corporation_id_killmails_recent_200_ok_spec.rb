...
# Unit tests for EveESIClient::GetCorporationsCorporationIdKillmailsRecent200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdKillmailsRecent200Ok' do
  before do
    # run before each test
    @instance = EveESIClient::GetCorporationsCorporationIdKillmailsRecent200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdKillmailsRecent200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdKillmailsRecent200Ok' do
      expect(@instance).to be_instance_of(EveESIClient::GetCorporationsCorporationIdKillmailsRecent200Ok)
    end
  end
