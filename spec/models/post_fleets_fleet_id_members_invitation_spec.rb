...
# Unit tests for EveESIClient::PostFleetsFleetIdMembersInvitation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostFleetsFleetIdMembersInvitation' do
  before do
    # run before each test
    @instance = EveESIClient::PostFleetsFleetIdMembersInvitation.new
  end
  ...
  describe 'test an instance of PostFleetsFleetIdMembersInvitation' do
    it 'should create an instance of PostFleetsFleetIdMembersInvitation' do
      expect(@instance).to be_instance_of(EveESIClient::PostFleetsFleetIdMembersInvitation)
    end
  end
