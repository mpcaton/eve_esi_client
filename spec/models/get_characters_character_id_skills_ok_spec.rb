...
# Unit tests for EveESIClient::GetCharactersCharacterIdSkillsOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdSkillsOk' do
  before do
    # run before each test
    @instance = EveESIClient::GetCharactersCharacterIdSkillsOk.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdSkillsOk' do
    it 'should create an instance of GetCharactersCharacterIdSkillsOk' do
      expect(@instance).to be_instance_of(EveESIClient::GetCharactersCharacterIdSkillsOk)
    end
  end
