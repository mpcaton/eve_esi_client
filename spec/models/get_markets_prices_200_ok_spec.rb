...
# Unit tests for EveESIClient::GetMarketsPrices200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMarketsPrices200Ok' do
  before do
    # run before each test
    @instance = EveESIClient::GetMarketsPrices200Ok.new
  end
  ...
  describe 'test an instance of GetMarketsPrices200Ok' do
    it 'should create an instance of GetMarketsPrices200Ok' do
      expect(@instance).to be_instance_of(EveESIClient::GetMarketsPrices200Ok)
    end
  end
