...
# Unit tests for EveESIClient::FactionWarfareApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FactionWarfareApi' do
  before do
    # run before each test
    @instance = EveESIClient::FactionWarfareApi.new
  end
  ...
  describe 'test an instance of FactionWarfareApi' do
    it 'should create an instance of FactionWarfareApi' do
      expect(@instance).to be_instance_of(EveESIClient::FactionWarfareApi)
    end
  end
