...
api_instance = EveESIClient::RoutesApi.new
...
opts = { 
  ...
  connections: [EveESIClient::Array<Integer>.new], # Array<Array<Integer>> | connected solar system pairs
