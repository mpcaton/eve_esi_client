...
module EveESIClient
  class LoyaltyApi
    ...
    def get_characters_character_id_loyalty_points_with_http_info(character_id, opts = {})
      ...
      # resource path
      local_var_path = "/v1/characters/{character_id}/loyalty/points/".sub('{' + 'character_id' + '}', character_id.to_s)
    ...
    def get_loyalty_stores_corporation_id_offers_with_http_info(corporation_id, opts = {})
      ...
      # resource path
      local_var_path = "/v1/loyalty/stores/{corporation_id}/offers/".sub('{' + 'corporation_id' + '}', corporation_id.to_s)
