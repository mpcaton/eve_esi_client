...
module EveESIClient
  class ClonesApi
    ...
    def get_characters_character_id_clones_with_http_info(character_id, opts = {})
      ...
      # resource path
      local_var_path = "/v2/characters/{character_id}/clones/".sub('{' + 'character_id' + '}', character_id.to_s)
    ...
    def get_characters_character_id_implants_with_http_info(character_id, opts = {})
      ...
      # resource path
      local_var_path = "/v1/characters/{character_id}/implants/".sub('{' + 'character_id' + '}', character_id.to_s)
