...
module EveESIClient
  class LocationApi
    ...
    def get_characters_character_id_location_with_http_info(character_id, opts = {})
      ...
      # resource path
      local_var_path = "/v1/characters/{character_id}/location/".sub('{' + 'character_id' + '}', character_id.to_s)
    ...
    def get_characters_character_id_online_with_http_info(character_id, opts = {})
      ...
      # resource path
      local_var_path = "/v1/characters/{character_id}/online/".sub('{' + 'character_id' + '}', character_id.to_s)
    ...
    def get_characters_character_id_ship_with_http_info(character_id, opts = {})
      ...
      # resource path
      local_var_path = "/v1/characters/{character_id}/ship/".sub('{' + 'character_id' + '}', character_id.to_s)
