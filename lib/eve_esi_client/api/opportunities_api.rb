...
module EveESIClient
  class OpportunitiesApi
    ...
    def get_characters_character_id_opportunities_with_http_info(character_id, opts = {})
      ...
      # resource path
      local_var_path = "/v1/characters/{character_id}/opportunities/".sub('{' + 'character_id' + '}', character_id.to_s)
    ...
    def get_opportunities_groups_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/v1/opportunities/groups/"
    ...
    def get_opportunities_groups_group_id_with_http_info(group_id, opts = {})
      ...
      # resource path
      local_var_path = "/v1/opportunities/groups/{group_id}/".sub('{' + 'group_id' + '}', group_id.to_s)
    ...
    def get_opportunities_tasks_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/v1/opportunities/tasks/"
    ...
    def get_opportunities_tasks_task_id_with_http_info(task_id, opts = {})
      ...
      # resource path
      local_var_path = "/v1/opportunities/tasks/{task_id}/".sub('{' + 'task_id' + '}', task_id.to_s)
