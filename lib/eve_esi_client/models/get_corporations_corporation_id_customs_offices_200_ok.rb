...
module EveESIClient
  ...
  class GetCorporationsCorporationIdCustomsOffices200Ok
    ...
    def hash
      [office_id, system_id, reinforce_exit_start, reinforce_exit_end, corporation_tax_rate, allow_alliance_access, alliance_tax_rate, allow_access_with_standings, standing_level, excellent_standing_tax_rate, good_standing_tax_rate, neutral_standing_tax_rate, bad_standing_tax_rate, terrible_standing_tax_rate].hash
    end
