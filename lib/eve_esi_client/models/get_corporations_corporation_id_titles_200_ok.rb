...
module EveESIClient
  ...
  class GetCorporationsCorporationIdTitles200Ok
    ...
    def hash
      [title_id, name, roles, grantable_roles, roles_at_hq, grantable_roles_at_hq, roles_at_base, grantable_roles_at_base, roles_at_other, grantable_roles_at_other].hash
    end
