...
module EveESIClient
  ...
  class GetFwLeaderboardsCorporationsVictoryPoints
    ...
    def self.swagger_types
      {
        ...
        :'last_week' => :'Array<GetFwLeaderboardsCorporationsLastWeek1>',
        :'active_total' => :'Array<GetFwLeaderboardsCorporationsActiveTotal1>'
      }
    end
    ...
    def hash
      [yesterday, last_week, active_total].hash
    end
