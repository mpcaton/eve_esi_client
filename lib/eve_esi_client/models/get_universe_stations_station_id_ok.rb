...
module EveESIClient
  ...
  class GetUniverseStationsStationIdOk
    ...
    def hash
      [station_id, name, owner, type_id, race_id, position, system_id, reprocessing_efficiency, reprocessing_stations_take, max_dockable_ship_volume, office_rental_cost, services].hash
    end
