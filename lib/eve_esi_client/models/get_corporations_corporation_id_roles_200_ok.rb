...
module EveESIClient
  ...
  class GetCorporationsCorporationIdRoles200Ok
    ...
    def hash
      [character_id, roles, grantable_roles, roles_at_hq, grantable_roles_at_hq, roles_at_base, grantable_roles_at_base, roles_at_other, grantable_roles_at_other].hash
    end
