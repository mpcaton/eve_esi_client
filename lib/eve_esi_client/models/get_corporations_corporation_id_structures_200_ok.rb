...
module EveESIClient
  ...
  class GetCorporationsCorporationIdStructures200Ok
    ...
    def hash
      [structure_id, type_id, corporation_id, system_id, profile_id, current_vul, next_vul, fuel_expires, services, state_timer_start, state_timer_end, unanchors_at].hash
    end
