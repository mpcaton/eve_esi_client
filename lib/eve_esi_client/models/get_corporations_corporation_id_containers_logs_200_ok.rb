...
module EveESIClient
  ...
  class GetCorporationsCorporationIdContainersLogs200Ok
    ...
    def hash
      [logged_at, container_id, container_type_id, character_id, location_id, location_flag, action, password_type, type_id, quantity, old_config_bitmask, new_config_bitmask].hash
    end
