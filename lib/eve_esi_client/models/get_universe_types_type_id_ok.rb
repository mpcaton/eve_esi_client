...
module EveESIClient
  ...
  class GetUniverseTypesTypeIdOk
    ...
    def hash
      [type_id, name, description, published, group_id, market_group_id, radius, volume, packaged_volume, icon_id, capacity, portion_size, mass, graphic_id, dogma_attributes, dogma_effects].hash
    end
