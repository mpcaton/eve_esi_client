...
module EveESIClient
  ...
  class GetCharactersCharacterIdOrders200Ok
    ...
    def valid?
      ...
      state_validator = EnumAttributeValidator.new('String', ["cancelled", "character_deleted", "closed", "expired", "open", "pending"])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('String', ["cancelled", "character_deleted", "closed", "expired", "open", "pending"])
    ...
    def hash
      [order_id, type_id, region_id, location_id, range, is_buy_order, price, volume_total, volume_remain, issued, state, min_volume, account_id, duration, is_corp, escrow].hash
    end
