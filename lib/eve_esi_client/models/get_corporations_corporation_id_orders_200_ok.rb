...
module EveESIClient
  ...
  class GetCorporationsCorporationIdOrders200Ok
    ...
    def hash
      [order_id, type_id, region_id, location_id, range, is_buy_order, price, volume_total, volume_remain, issued, state, min_volume, wallet_division, duration, escrow].hash
    end
